...
num_epoch = 2
batch_size = 8
learning_rate = 0.1  # Warning: lr and decay vary across optimizers
decay_rate = 0.0
...
model.save('ModelOutputs/LensJPG_stack_'+fileOut+'.hdf5')
...
np.save('ModelOutputs/LensJPG_stack_history_'+fileOut+'.npy', training_hist)
